...
public abstract class AbstractPendulum {
    ...
    private boolean validGC (GravityConstant val) { return (val.getGravitionalField() >= 0); }
    ...
    public double getGravitationalField () { return gr.getGravitionalField(); }
