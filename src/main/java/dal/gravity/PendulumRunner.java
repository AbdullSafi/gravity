...
public class PendulumRunner {
	...
	RegularPendulum rp = new RegularPendulum (sLen, pMass, theta0, delta, new GravityConstant(/*some double*/));
	SimplePendulum sp = new SimplePendulum (sLen, pMass, theta0,new GravityConstant(/*some double*/));
	RegularPendulum rpCoarse = 
	    new RegularPendulum (sLen, pMass, theta0, .1, new GravityConstant(/*some double*/));
